...
#ifndef YY_YY_HOME_ALBERTON_DESKTOP_SIGNAL_GENERATOR_SRC_SHARED_PARSER_PARSER_H_INCLUDED
# define YY_YY_HOME_ALBERTON_DESKTOP_SIGNAL_GENERATOR_SRC_SHARED_PARSER_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
